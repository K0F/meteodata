...
Data spans **2025-11-06 → 2026-09-15** (89,106 deduplicated records).
...
The station id changes over time (87 → 75 → 131), likely battery swaps in the
outdoor unit. There is a data gap **2025-12-01 → 2026-05-23** (logging outage)
and a short gap 2026-09-07 → 2026-09-10. Raw files overlap on 2026-07-30;
`scripts/merge.py` deduplicates by `(time, id)`.

`battery_ok: 0` in the Nov 2025 batch indicates the old battery was low.
